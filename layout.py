...
class Layout:
    ...
    def __init__(self, layoutText):
        ...
        self.keys = Grid(self.width,self.height,False)
    ...
    def processLayoutText(self, layoutText):
        ...
        represents a different type of object.
         ...
         G - Ghost
         P - Pacman
         D - Door  --- TO DO -> trebuie sa stocam in doors[x][y]
         K - Key   ---- TO DO -> trebuie sa stocam in keys[x][y] . (luam si un contor de chei  available
                                                                     sa vedem daca se poate deschide usa )
